...
namespace :salt do
  ...
  task create_cert_ob: :environment do
    create_cert_by_type(TYPE_OBSEAL)
  end

  task create_cert_bg: :environment do
    create_cert_by_type(TYPE_QSEAL)
  end

  desc "Register tpp"
  task register_tpp: :environment do
    # TODO: OB register instead of BG
    # puts SaltEdge::BG::RegisterTppService.call
  end

  desc "Adding certificate to tpp"
  task add_certificate: :environment do
    puts SaltEdge::BG::AddCertificateService.call
    # puts SaltEdge::OB::AddCertificateService.call
  end
